...
type Pessoa = { id: number; nome: string; cargo: string; setor: string; ativo: boolean; foto_url?: string; created_at?: string; };
type Lancamento = { id: number; pessoa_id: number; tipo: string; data: string; horas?: number; minutos?: number; descricao?: string; created_at?: string; };
type BonusElegibilidade = { id: number; pessoa_id: number; elegivel: boolean; data_inicio_elegibilidade?: string; data_desclassificacao?: string; motivo_desclassificacao?: string; reversivel?: boolean; valor_calculado?: number; valor_bonus?: number; };
type Auditoria = { id: number; tabela: string; acao: string; usuario: string; dados_anteriores?: any; dados_novos?: any; criado_em: string; };
